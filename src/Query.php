...
use PDO;
use rwt\SwiftPDO\Queries\{Insert, Select, Update, Delete};

/**
 * SwiftPDO is a quick and light PHP library for rapid query building.
 * Highly compatible with latest PDO compatible SQL Databases for fast migration and handles with "reserved words" issues.
 * It features a smart join builder, which automatically creates table joins.
 * The library originally forked from FluentPDO library as base library for the SwiftPDO project.
 *
 *
 * For more information see readme.md
 *
 * @version     1.1.0
 * @link        https://github.com/romandulman/swiftpdo
 * @author      Roman Dulman, info@reactivewebtech.com, roman.dulman@reactivewebtech.com
 * @copyright   2020-2021 RWT, Reactive Web Technologies - Roman Dulman
 * @license     GPL 3.0   https://www.gnu.org/licenses/gpl-3.0.en.html GNU General Public License, version 3.0
 * @license     APACHE 2.0 https://www.apache.org/licenses/LICENSE-2.0.txt Apache License, Version 2.0
 */

/**
 * Class Query
 * @method debug(rwt\SwiftPDO\Queries\Base $param)
 */
class Query
{
    /** @var PDO */
